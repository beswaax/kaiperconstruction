...
export default function HowItWorks(props) {
  ...
  const content = {
    badge: "ACHIEVE MORE",
    "header-p1": "Fluvius - the expert for your future project",
    description:
      "As a general provider of construction services, we supply our customers with everything from a single source.",
    description2:
    ...
    description3:
      "Whether architectural design, construction management or consultancy, we look after your project from the first consultation through planning to the final implementation.",
    ...
    "col2-desc":
      " The manager shall provide leadership to the construction management team on all matters relating to construction. ",
